// CcccDevStudioAddIn.cpp : Defines the initialization routines for the DLL.
//
...
/////////////////////////////////////////////////////////////////////////////
// CCcccDevStudioAddInApp

class CCcccDevStudioAddInApp : public CWinApp
{
public:
	CCcccDevStudioAddInApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCcccDevStudioAddInApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CCcccDevStudioAddInApp)
...
BEGIN_MESSAGE_MAP(CCcccDevStudioAddInApp, CWinApp)
	//{{AFX_MSG_MAP(CCcccDevStudioAddInApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CCcccDevStudioAddInApp object

CCcccDevStudioAddInApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CCcccDevStudioAddInApp construction

CCcccDevStudioAddInApp::CCcccDevStudioAddInApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CCcccDevStudioAddInApp initialization

BOOL CCcccDevStudioAddInApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CCcccDevStudioAddInApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_CCCCDEVSTUDIOADDIN_DESCRIPTION);
